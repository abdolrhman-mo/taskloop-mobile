          ...
          <TouchableWithoutFeedback>
            <View style={[styles.modalContent, { backgroundColor: theme.background.secondary }]}> 
              ...
              <View style={styles.descriptionContainer}>
                <Text style={[styles.description, { color: theme.typography.secondary }]}>Share this link with your friends to let them join.</Text>
              </View>
                  ...
                  <View style={styles.buttonContent}>
                    {copyState.isCopied ? (
                      <>
                        ...
                        <ThemedText style={[styles.buttonText, { color: theme.brand.background }]}>Link Copied!</ThemedText>
                      </>
                    ) : (
                      <>
                        <Copy size={20} color={theme.brand.background} />
                        <ThemedText style={[styles.buttonText, { color: theme.brand.background }]}>Copy Room Link</ThemedText>
                      </>
                    )}
                  </View>
                </TouchableOpacity>
                {copyState.error && (
                  <ThemedText style={[styles.error, { color: theme.error.DEFAULT }]}>{copyState.error}</ThemedText>
                )}
              </View>
            </View>
          </TouchableWithoutFeedback>
